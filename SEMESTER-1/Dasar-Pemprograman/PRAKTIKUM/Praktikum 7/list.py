...
print(f"NbElmt([1,2,3,4,5]) = {NbElmt([1,2,3,4,5])}")
...
print(f"ElmtKeN(3,[1,2,3,4,5]) = {ElmtKeN(3,[1,2,3,4,5])}")
...
print(f"IsMember(X,L) = {IsMember(6,[1,2,3,4,5])}")
...
print(f"Copy([1,2,3,4,5]) = {Copy([1,2,3,4,5])}")
...
print(f"Inverse([1,2,3,4,5]) = {Inverse([1,2,3,4,5])}")
...
print(f"SumElmt([1,2,3,4,5]) = {SumElmt([1,2,3,4,5])}")
...
print(f"AvgElmt([1,2,3,4,5]) = {AvgElmt([1,2,3,4,5])}")
...
print(f"MaxElmt([1,2,3,4,5]) = {MaxElmt([1,2,3,4,5])}")
...
print(f"CekD(4,[1,2,3,4,5]) = {CekD(4,[1,2,3,4,5])}")
...
print(f"MaxNB([1,2,3,4,5]) = {MaxNB([1,2,3,4,5])}")
...
print(f"AddList([1,2,3],[4,5,6]) = {AddList([1,2,3],[4,5,6])}")
...
print(f"IsPalindrom(['K','A','S','U','R',' ','R','U','S','A','K']) = {IsPalindrom(['K','A','S','U','R',' ','R','U','S','A','K'])}")


print(IsMember(4,[1,2,3]))
print(Copy([1,2,3]))
print(Inverse([1,2,3]))
print(Konkat([1,2,3],[2,1]))
print(SumElmt([1,2,3]))
print(AvgElmt([1,2,3]))
print(MaxElmt([1,2,3,4]))
print(AddList([1,2],[4,5,6]))
print(IsPalindrom(["K","A","S","U","R"," ","R","U","S","A","K"]))
print(IsPalindrom(["N","A","B","A","N","A","N"]))
